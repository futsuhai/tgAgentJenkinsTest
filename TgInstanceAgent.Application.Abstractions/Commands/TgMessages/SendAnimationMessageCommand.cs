...
/// <summary>
/// Команда для отправки сообщения с анимацией
/// </summary>
public class SendAnimationMessageCommand : IWithChat, IWithSendOptions, IWithFile, IWithInstanceId, IRequest<TgMessage>
{
    /// <summary>
