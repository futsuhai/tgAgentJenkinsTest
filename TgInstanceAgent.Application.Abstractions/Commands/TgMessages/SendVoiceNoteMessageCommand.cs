...
/// <summary>
/// Команда для отправки голосовой заметки сообщением.
/// </summary>
public class SendVoiceNoteMessageCommand : IWithChat, IWithSendOptions, IWithFile, IWithInstanceId, IRequest<TgMessage>
{
    /// <summary>
