...
/// <summary>
/// Команда для отправки сообщения с геолокацией.
/// </summary>
public class SendLocationMessageCommand : IWithChat, IWithSendOptions, IWithInstanceId, IRequest<TgMessage>
{
    /// <summary>
    ...
    /// <summary>
    /// Широта местоположения в градусах; определена отправителем.
    /// </summary>
    public required double Latitude { get; init; }

    /// <summary>
    /// Долгота местоположения, в градусах; определена отправителем.
    /// </summary>
    public required double Longitude { get; init; }

    /// <summary>
    /// Ориентировочная горизонтальная точность местоположения, в метрах.
    /// </summary>
