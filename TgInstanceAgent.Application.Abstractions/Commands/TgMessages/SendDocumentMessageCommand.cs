...
/// <summary>
/// Команда для отправки документа соообщением.
/// </summary>
public class SendDocumentMessageCommand : IWithChat, IWithSendOptions, IWithFile, IWithInstanceId, IRequest<TgMessage>
{
    /// <summary>
