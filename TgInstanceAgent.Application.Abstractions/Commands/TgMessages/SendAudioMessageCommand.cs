...
/// <summary>
/// Команда для отправки аудиосообщения.
/// </summary>
public class SendAudioMessageCommand : IWithChat, IWithSendOptions, IWithFile, IWithThumbnail, IWithInstanceId, IRequest<TgMessage>
{
    /// <summary>
    /// Название аудио.
    /// </summary>
