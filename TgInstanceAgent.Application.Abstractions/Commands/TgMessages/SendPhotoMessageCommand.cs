...
/// <summary>
/// Команда для отправки фотографии сообщением.
/// </summary>
public class SendPhotoMessageCommand : IWithChat, IWithFile, IWithSendOptions, IWithInstanceId, IRequest<TgMessage>
{
    /// <summary>
