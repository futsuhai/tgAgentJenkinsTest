...
/// <summary>
/// Команда для добавления пересылки сообщений
/// </summary>
public class AddForwardEntryCommand : IRequest, IWithCommandId, IWithInstanceId
{
    /// <summary>
    ...
    /// </summary>
    public required bool SendCopy { get; init; }
}