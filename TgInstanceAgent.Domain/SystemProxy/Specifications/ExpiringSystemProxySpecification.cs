...
/// <inheritdoc/>
/// <summary>
/// Спецификация для системных прокси с временем жизни менее 24 часа.
/// </summary>
public class ExpiringSystemProxySpecification : ISpecification<SystemProxyAggregate, ISystemProxySpecificationVisitor>
{
    /// <inheritdoc/>
    /// <summary>
