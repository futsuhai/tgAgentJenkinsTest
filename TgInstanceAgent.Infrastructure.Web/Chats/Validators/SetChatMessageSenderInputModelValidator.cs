...
/// <summary>
/// Валидатор для SetChatMessageSenderInputModel.
/// </summary>
public class SetChatMessageSenderInputModelValidator : AbstractValidator<SetChatMessageSenderInputModel>
{
    /// <summary>
    /// Конструктор валидатора
    /// </summary>
    public SetChatMessageSenderInputModelValidator()
    {
        // Правило для ChatId
        RuleFor(x => x.ChatId)
