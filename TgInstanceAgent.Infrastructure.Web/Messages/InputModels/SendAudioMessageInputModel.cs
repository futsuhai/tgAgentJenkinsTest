...
/// <summary>
/// Модель входных данных для отправки аудио-сообщения.
/// </summary>
public class SendAudioMessageInputModel : IWithInputChat, IWithInputFile, IWithInputCaption, IWithInputSendOption, IWithInputThumbnail
{
    /// <summary>
    /// Идентификатор чата.
    ...
    /// <summary>
    /// Заголовок аудио-сообщения.
    /// </summary>
    public string? Title { get; init; }

    /// <summary>
    /// Исполнитель аудио-сообщения.
    /// </summary>
