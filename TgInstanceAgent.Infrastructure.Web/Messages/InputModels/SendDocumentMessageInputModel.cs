...
/// <summary>
/// Модель входных данных для отправки документа.
/// </summary>
public class SendDocumentMessageInputModel : IWithInputChat, IWithInputFile, IWithInputCaption, IWithInputSendOption
{
    /// <summary>
    /// Идентификатор чата.
