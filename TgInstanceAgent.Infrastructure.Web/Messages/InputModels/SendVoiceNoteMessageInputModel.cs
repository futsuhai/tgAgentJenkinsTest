...
/// <summary>
/// Модель входных данных для отправки голосового сообщения.
/// </summary>
public class SendVoiceNoteMessageInputModel : IWithInputChat, IWithInputFile, IWithInputCaption, IWithInputSendOption
{
    /// <summary>
    /// Идентификатор чата.
