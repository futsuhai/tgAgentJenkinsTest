...
/// <summary>
/// Модель входных данных для отправки сообщения с видео.
/// </summary>
public class SendVideoMessageInputModel : IWithInputChat, IWithInputFile, IWithInputCaption, IWithInputSendOption
{
    /// <summary>
    /// Идентификатор чата.
