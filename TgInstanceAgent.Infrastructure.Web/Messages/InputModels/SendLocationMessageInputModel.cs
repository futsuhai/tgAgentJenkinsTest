...
/// <summary>
/// Модель входных данных для отправки сообщения с местоположением.
/// </summary>
public class SendLocationMessageInputModel : IWithInputChat, IWithInputSendOption
{
    /// <summary>
    /// Идентификатор чата.
   ...
   public long? ChatId { get; init; }
    ...
    /// <summary>
    /// Горизонтальная точность местоположения.
    /// </summary>
