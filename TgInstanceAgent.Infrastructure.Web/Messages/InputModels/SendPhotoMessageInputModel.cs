...
/// <summary>
/// Модель входных данных для отправки сообщения с фотографией.
/// </summary>
public class SendPhotoMessageInputModel : IWithInputChat, IWithInputFile, IWithInputCaption, IWithInputSendOption
{
    /// <summary>
    /// Идентификатор чата.
