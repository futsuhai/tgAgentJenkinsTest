...
/// <summary>
/// Модель входных данных для отправки сообщения с анимацией
/// </summary>
public class SendAnimationMessageInputModel : IWithInputChat, IWithInputFile, IWithInputCaption, IWithInputSendOption
{
    /// <summary>
    /// Идентификатор чата.
