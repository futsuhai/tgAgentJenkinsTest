...
/// <summary>
/// Модель входных данных для отправки текстового сообщения.
/// </summary>
public class SendTextMessageInputModel : IWithInputChat, IWithInputSendOption
{
    /// <summary>
    /// Идентификатор чата.
