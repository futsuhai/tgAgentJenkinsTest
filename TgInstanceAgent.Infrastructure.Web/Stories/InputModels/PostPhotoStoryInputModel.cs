...
/// <summary>
/// Модель входных данных для отправки истории с фотографией
/// </summary>
public class PostPhotoStoryInputModel : IWithInputChat, IWithInputFile, IWithInputCaption, IWithInputStoryPrivacySettings
{
    /// <summary>
    /// Идентификатор чата.
