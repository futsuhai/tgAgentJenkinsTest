...
/// <summary>
/// Валидатор для SendVideoStoryInputModel
/// </summary>
public class PostVideoStoryInputModelValidator : AbstractValidator<PostVideoStoryInputModel>
{
    /// <summary>
    /// Конструктор
    /// </summary>
    public PostVideoStoryInputModelValidator()
    {
